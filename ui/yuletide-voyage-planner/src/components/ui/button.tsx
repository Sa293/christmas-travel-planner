  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gold text-foreground font-semibold shadow-glow hover:scale-105 hover:shadow-warm border-2 border-gold-dark/20",
        festive: "bg-primary text-primary-foreground border-2 border-gold/30 shadow-warm hover:bg-primary/90 hover:border-gold/50",
        gold: "bg-gradient-to-r from-gold to-gold-dark text-foreground font-semibold hover:scale-105 transition-transform shadow-glow",
      },
      size: {
